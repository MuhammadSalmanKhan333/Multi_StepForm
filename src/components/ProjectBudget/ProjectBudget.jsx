...
const ProjectBudget = ({ value, error, setFieldValue }) => {
  ...
  return (
    <div className="flex flex-col w-[100%] gap-9 md:h-[22.4rem]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div
          className={`border p-4 md:p-10 shadow-md rounded-2xl cursor-pointer flex gap-4 items-
           ${
             value.price === "$5.000 - $10.000"
        ...
        >
          <input
            ...
            value="$5.000 - $10.000"
            onChange={() => handlePrice("$5.000 - $10.000")}
          />
        ...
        >
          <input
            ...
            onChange={() => handlePrice("$10.000 - $20.000")}
          />
          <label
            htmlFor="second"
        ...
        >
          <input
            ...
            onChange={() => handlePrice("$20.000 - $50.000")}
          />
        ...
        <div
          // onClick={() => handleServiceSelect("$50.000 +")}
          className={`border p-4 md:p-10 shadow-md rounded-2xl cursor-pointer flex gap-4 items-center
